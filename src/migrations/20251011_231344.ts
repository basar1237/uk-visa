...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_features_grid_features_icon" AS ENUM('globe', 'phone', 'clock', 'scales', 'passport', 'document', 'filetext', 'filecheck', 'stamp', 'clipboardcheck', 'receipt', 'house', 'heart', 'users', 'crown', 'justice', 'briefcase', 'building', 'building2', 'landmark', 'university', 'plane', 'mappin', 'navigation', 'compass', 'map', 'flag', 'graduation', 'bookopen', 'mail', 'lock', 'shield', 'handcuffs', 'checkcircle', 'checkcircle2', 'usercheck', 'badgecheck', 'thumbsup', 'star', 'award', 'rocket', 'zap', 'trending', 'trendingdown', 'target', 'sparkles', 'banknote', 'wallet', 'creditcard', 'calendar', 'calendarcheck', 'timer', 'hourglass', 'barchart', 'piechart', 'languages');
  CREATE TYPE "public"."enum_pages_blocks_services_grid_services_icon" AS ENUM('globe', 'phone', 'clock', 'scales', 'passport', 'document', 'filetext', 'filecheck', 'stamp', 'clipboardcheck', 'receipt', 'house', 'heart', 'users', 'crown', 'justice', 'briefcase', 'building', 'building2', 'landmark', 'university', 'plane', 'mappin', 'navigation', 'compass', 'map', 'flag', 'graduation', 'bookopen', 'mail', 'lock', 'shield', 'handcuffs', 'checkcircle', 'checkcircle2', 'usercheck', 'badgecheck', 'thumbsup', 'star', 'award', 'rocket', 'zap', 'trending', 'trendingdown', 'target', 'sparkles', 'banknote', 'wallet', 'creditcard', 'calendar', 'calendarcheck', 'timer', 'hourglass', 'barchart', 'piechart', 'languages');
  ...
  CREATE TYPE "public"."enum_pages_blocks_landing_block_background_style" AS ENUM('gradient', 'white', 'gray');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_features_grid_features_icon" AS ENUM('globe', 'phone', 'clock', 'scales', 'passport', 'document', 'filetext', 'filecheck', 'stamp', 'clipboardcheck', 'receipt', 'house', 'heart', 'users', 'crown', 'justice', 'briefcase', 'building', 'building2', 'landmark', 'university', 'plane', 'mappin', 'navigation', 'compass', 'map', 'flag', 'graduation', 'bookopen', 'mail', 'lock', 'shield', 'handcuffs', 'checkcircle', 'checkcircle2', 'usercheck', 'badgecheck', 'thumbsup', 'star', 'award', 'rocket', 'zap', 'trending', 'trendingdown', 'target', 'sparkles', 'banknote', 'wallet', 'creditcard', 'calendar', 'calendarcheck', 'timer', 'hourglass', 'barchart', 'piechart', 'languages');
  CREATE TYPE "public"."enum__pages_v_blocks_services_grid_services_icon" AS ENUM('globe', 'phone', 'clock', 'scales', 'passport', 'document', 'filetext', 'filecheck', 'stamp', 'clipboardcheck', 'receipt', 'house', 'heart', 'users', 'crown', 'justice', 'briefcase', 'building', 'building2', 'landmark', 'university', 'plane', 'mappin', 'navigation', 'compass', 'map', 'flag', 'graduation', 'bookopen', 'mail', 'lock', 'shield', 'handcuffs', 'checkcircle', 'checkcircle2', 'usercheck', 'badgecheck', 'thumbsup', 'star', 'award', 'rocket', 'zap', 'trending', 'trendingdown', 'target', 'sparkles', 'banknote', 'wallet', 'creditcard', 'calendar', 'calendarcheck', 'timer', 'hourglass', 'barchart', 'piechart', 'languages');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_landing_block_background_style" AS ENUM('gradient', 'white', 'gray');
  ...
  CREATE TYPE "public"."enum_header_nav_items_dropdown_items_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_header_nav_items_dropdown_items_title_link_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE "pages_blocks_features_grid_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" "enum_pages_blocks_features_grid_features_icon",
  	"title" varchar,
  	"description" varchar
  );
  ...
  CREATE TABLE "pages_blocks_services_grid_services" (
  	...
  	"title" varchar,
  	"description" varchar,
  	"button_text" varchar DEFAULT 'More Info',
  	"button_link" varchar
  );
  ...
  CREATE TABLE "pages_blocks_landing_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"background_style" "enum_pages_blocks_landing_block_background_style" DEFAULT 'gradient',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_features_grid_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" "enum__pages_v_blocks_features_grid_features_icon",
  	"title" varchar,
  	"description" varchar,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_landing_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"background_style" "enum__pages_v_blocks_landing_block_background_style" DEFAULT 'gradient',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "header_nav_items_dropdown_items_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_header_nav_items_dropdown_items_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar
  );
  ...
  CREATE TABLE "header_nav_items_dropdown_items" (
  	...
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title_link_link_type" "enum_header_nav_items_dropdown_items_title_link_link_type" DEFAULT 'reference',
  	"title_link_link_new_tab" boolean,
  	"title_link_link_url" varchar,
  	"title_link_link_label" varchar,
  	"has_sub_dropdown" boolean DEFAULT false
  );
  ...
  ALTER TABLE "pages_blocks_landing_block" ADD CONSTRAINT "pages_blocks_landing_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_landing_block" ADD CONSTRAINT "_pages_v_blocks_landing_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "header_nav_items_dropdown_items_items" ADD CONSTRAINT "header_nav_items_dropdown_items_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header_nav_items_dropdown_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_features_grid_features_order_idx" ON "pages_blocks_features_grid_features" USING btree ("_order");
  CREATE INDEX "pages_blocks_features_grid_features_parent_id_idx" ON "pages_blocks_features_grid_features" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_blocks_landing_block_order_idx" ON "pages_blocks_landing_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_landing_block_parent_id_idx" ON "pages_blocks_landing_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_landing_block_path_idx" ON "pages_blocks_landing_block" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_features_grid_features_order_idx" ON "_pages_v_blocks_features_grid_features" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_features_grid_features_parent_id_idx" ON "_pages_v_blocks_features_grid_features" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_landing_block_order_idx" ON "_pages_v_blocks_landing_block" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_landing_block_parent_id_idx" ON "_pages_v_blocks_landing_block" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_landing_block_path_idx" ON "_pages_v_blocks_landing_block" USING btree ("_path");
  ...
  CREATE INDEX "header_nav_items_dropdown_items_items_order_idx" ON "header_nav_items_dropdown_items_items" USING btree ("_order");
  CREATE INDEX "header_nav_items_dropdown_items_items_parent_id_idx" ON "header_nav_items_dropdown_items_items" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_features_grid_features" CASCADE;
  ...
  DROP TABLE "pages_blocks_landing_block" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_features_grid_features" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_landing_block" CASCADE;
  ...
  DROP TABLE "header_nav_items_dropdown_items_items" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_features_grid_features_icon";
  ...
  DROP TYPE "public"."enum_pages_blocks_landing_block_background_style";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_features_grid_features_icon";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_landing_block_background_style";
  ...
  DROP TYPE "public"."enum_header_nav_items_dropdown_items_items_link_type";
  DROP TYPE "public"."enum_header_nav_items_dropdown_items_title_link_link_type";

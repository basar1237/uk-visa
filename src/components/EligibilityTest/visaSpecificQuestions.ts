...
export const visaSpecificQuestions: Record<string, Question[]> = {
  'Visitor Visa': [
    ...
    { id: 110, question: "What is the main purpose of your visit?", type: 'select', options: ['Tourism', 'Business', 'Family visit', 'Medical treatment', 'Other'], required: true, step: 2, category: "Visit Purpose" },
  ...
  'Visitors Visa': [
    // 1. About You
    { id: 2201, question: "What is your full name?", type: 'text', required: true, step: 1, category: "About You" },

          ...
          >
            <div className="grid grid-cols-1 gap-4 md:gap-6 lg:grid-cols-2 lg:gap-8 mb-6">
              ...
              <div className="flex flex-col justify-center mb-3 md:mb-0">
                  ...
                  {stats.map((stat, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-background rounded-xl shadow-md p-3 md:p-4 border border-gray-200 hover:border-blue-300 transition-colors text-center"
                      >
                ...
                <Link 
                  href="/comments"
                  className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium text-sm md:text-base transition-colors"
                >
                  View All Reviews →
                </Link>
              </div>
                  ...
                  <AnimatePresence mode="wait">
                    {testimonials.map((testimonial, index) => (
                      index === active && (
                        ...
                        >
                          <div className="bg-gradient-to-br from-white to-blue-50 rounded-2xl border-2 border-blue-200 px-5 py-5 md:px-7 md:py-7 shadow-xl hover:shadow-2xl transition-all duration-300 min-h-full flex flex-col">
                            {/* Quote Icon */}
                            <div className="mb-3">

...
const features: Feature[] = [
  {
    ...
    description: 'We work with carefully vetted immigration professionals who excel in their field, with a proven track record across all areas of UK immigration law.',
    highlight: true
  },
  {
    icon: HeartHandshake,
    title: 'Tailored, Personalised Support',
    description: 'Every case is unique. We match you with the right specialist for your situation, ensuring advice and representation are fully customised to your needs.',
    highlight: true
  },
  {
    icon: Globe,
    title: 'Flexibility and Convenience',
    description: 'Access our services remotely from anywhere in the world or meet our experts in person at our offices in Sheffield, Birmingham, Bradford or globally by arrangement.',
  },
  {
    icon: Zap,
    title: 'Fast-Track Services',
    description: 'For urgent immigration cases, we offer premium and super-premium expedited application processing, helping you get results faster when it matters most.',
  },
  {
    icon: Sparkles,
    title: 'Transparent and Clear',
    description: 'No hidden fees, no confusing jargon. Our platform provides straightforward pricing and clear guidance throughout your immigration journey.',
  },
  {
    icon: TrendingUp,
    title: 'Efficiency without Compromise',
    description: 'From assessment to representation, we streamline every step, enabling you to navigate UK immigration faster and with confidence.',
  }
]
                ...
                <div className="space-y-8 text-lg text-gray-600 leading-relaxed">
                  ...
                  <div className="space-y-2 pt-1 border-t border-gray-200">
                    ...
                    <p className="mb-2 text-md text-gray-700 font-medium">
                      <span className="font-semibold">Connecting You with Expert UK Immigration Support</span>
                    </p>
                    <p className="mb-4 text-md text-gray-700 font-medium">
                      UK Immigration Helpline was founded to bridge the gap between individuals seeking reliable immigration assistance and the legal professionals best equipped to help. Every case is carefully evaluated by our firm, which is regulated by the Bar Standards Board, ensuring professional, trustworthy service from the very start.
                    </p>
                    <p className="mb-4 text-md text-gray-700 font-medium">
                      We work with a panel of independent solicitors and barristers with proven expertise across all areas of UK immigration law. This allows us to match you with the specialist best suited to your unique circumstances, whether it&apos;s for visas, settlement, or complex immigration challenges.
                    </p>
                    <p className="mb-4 text-md text-gray-700 font-medium">
                      Our platform is designed to make the process flexible and convenient. Most of our services can be completed entirely online, giving you access to expert advice from the comfort of your home or office. For those who prefer face-to-face consultations, we have offices in Sheffield, Birmingham, and Bradford, as well as options to meet our team globally (please contact us for details).
                    </p>
                    <p className="text-md text-gray-700 font-medium">
              ...
              >
                <div className="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl">
                  ...
                  <div className="space-y-2 pt-1 border-t border-gray-200">
                    ...
                    <p className="mb-4 text-md text-gray-700 font-medium">
                      At UK Immigration Helpline, we make accessing expert immigration support simple, transparent, and tailored to your needs. Our platform is designed to connect you with the right lawyer, at the right time, whether your case is straightforward or complex.
                    </p>
                    <p className="mb-3 text-md text-gray-700 font-medium">
                      Our services include:
                    </p>
                    <ul className="space-y-3 ml-6 list-none mb-4">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-blue-600 flex-shrink-0 mt-1" />
                        <span><span className="font-semibold">Personalised Assessment:</span> Smart eligibility tools and tailored enquiry forms evaluate your unique situation.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-blue-600 flex-shrink-0 mt-1" />
                        <span><span className="font-semibold">Expert Matching:</span> We connect you with solicitors or barristers who specialize in your specific area of UK immigration law.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-blue-600 flex-shrink-0 mt-1" />
                        <span><span className="font-semibold">Seamless Support:</span> Instantly access consultations, case preparation, and ongoing guidance from trusted legal professionals.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-blue-600 flex-shrink-0 mt-1" />
                        <span><span className="font-semibold">Transparent Process:</span> Clear information, straightforward pricing, and reliable, regulated partners ensure you know exactly what to expect.</span>
                      </li>
                    </ul>
                    <p className="text-md text-gray-700 font-medium">
                      Whether you choose to work remotely from home or meet our experts in person at one of our UK offices or globally, we provide efficient, professional, and client-focused immigration support every step of the way.
                    </p>
                  </div>
              ...
              {[
                {
                  icon: HeartHandshake,
                  title: 'Empathy & Care',
                  description: 'We recognise that immigration matters are deeply personal. Every client receives compassionate, respectful, and individualised support tailored to their circumstances.',
                  gradient: 'from-pink-500 to-rose-500'
                },
                {
                  icon: Shield,
                  title: 'Integrity & Trust',
                  description: 'We uphold the highest ethical standards. You can expect honest advice, transparent processes, and guidance you can rely on at every stage of your journey.',
                  gradient: 'from-blue-500 to-cyan-500'
                },
                {
                  icon: Target,
                  title: 'Excellence',
                  description: 'We never settle for "good enough". Each application is carefully prepared with accuracy and attention to detail, maximising your prospects of success.',
                  gradient: 'from-purple-500 to-indigo-500'
                },
                {
                  icon: BookOpen,
                  title: 'Expert Knowledge',
                  description: 'Our team consistently updates its knowledge to stay ahead of the ever-evolving UK immigration landscape, ensuring you receive accurate and up-to-date advice.',
              ...
              <div className="mt-12 pt-8 border-t border-white/20">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                  <div>
                    ...
                    <a href="tel:+447858780841" className="text-blue-100 hover:text-white transition-colors text-sm">
                      +44 7858 780841
                    </a>
                  </div>
                  <div>

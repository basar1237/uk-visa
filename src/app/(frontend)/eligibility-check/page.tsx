...
export const metadata: Metadata = {
  title: 'UK Visa Eligibility Check | Assessment',
  description:
    'Check your eligibility for UK visa applications with our comprehensive assessment. Get instant results and personalized recommendations.',
